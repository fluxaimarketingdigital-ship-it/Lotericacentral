      ...
      <div style={{background:"#fff", borderRadius:24, width:"100%", maxWidth:360, overflow:"hidden", position:"relative", boxShadow:"0 20px 50px rgba(0,0,0,0.5)"}}>
        ...
        <div style={{height:240, overflow:"hidden", position:"relative", background:"#000"}}>
          ...
          <img src={passos[passo].img} style={{
            ...
            position:"relative", 
            zIndex:1,
            padding: passo === 3 ? 10 : 0
          }} alt="passo"/>
          
          <div style={{position:"absolute", bottom:0, left:0, width:"100%", height:40, background:"linear-gradient(to top, rgba(255,255,255,0.2), transparent)", zIndex:2}}/>
        </div>

        <div style={{padding:25, textAlign:"center", background:"#fff", position:"relative", zIndex:5}}>
...
console.log("Tutorial updated with blurred background and new step 4.");
